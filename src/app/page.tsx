      ...
      <div className="relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32">
          ...
          <div className="text-center mb-24 max-w-4xl mx-auto animate-in fade-in slide-in-from-top-8 duration-1000">
            <Badge
              variant="outline"
              className="mb-6 px-4 py-1.5 rounded-full border-primary/20 bg-primary/5 text-primary font-bold tracking-tight text-sm"
            >
            ...
            <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-2xl mx-auto font-medium leading-relaxed">
              The premier ecosystem connecting Nepal's brightest professionals
              with industry-leading projects.
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <Button
                asChild
                size="lg"
                className="h-16 px-10 rounded-2xl font-bold text-xl shadow-2xl shadow-primary/30 transition-all hover:scale-105 active:scale-95 group"
              >
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="h-16 px-10 rounded-2xl font-bold text-xl bg-background/50 backdrop-blur-md border-primary/10 hover:border-primary/30 transition-all hover:scale-105 active:scale-95"
              >
          ...
          <div className="bg-card/40 backdrop-blur-xl rounded-[3rem] p-12 border border-white/10 text-center relative overflow-hidden group">
            ...
            <p className="text-muted-foreground font-medium mb-8 max-w-xl mx-auto italic">
              "Worklynk changed how we hire in Nepal. The quality of
              professionals is unmatched compared to local platforms."
            </p>
            <div className="flex justify-center items-center gap-2">
              {[1, 2, 3, 4, 5].map((s) => (
                <Star key={s} className="w-4 h-4 fill-primary text-primary" />
              ))}
              <span className="ml-2 font-bold text-sm tracking-widest uppercase opacity-70">
                Top Rated 2026
              </span>
            </div>
          </div>
...
function RoleCard({
  ...
  return (
    <div
      className={`p-10 rounded-[2.5rem] border transition-all duration-500 group overflow-hidden relative ${isPrimary ? "bg-primary/5 hover:bg-primary/10 border-primary/10 hover:border-primary/20" : "bg-card/40 hover:bg-card/60 border-muted/50 hover:border-primary/20 shadow-xl shadow-black/5"}`}
    >
      <div
        className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-8 transition-transform group-hover:scale-110 duration-500 ${isPrimary ? "bg-primary text-white shadow-xl shadow-primary/30" : "bg-secondary text-secondary-foreground"}`}
      >
        {icon}
      </div>
      <Badge
      ...
      <Button
        ...
        className="h-12 px-8 rounded-xl font-bold group/btn"
      >
